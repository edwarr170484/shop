function subscribe() {
  $.ajax({
    url: "index.php?route=tool/subscribe",
    type: "post",
    data: "email=" + $("#subscribe-email").val(),
    dataType: "json",
    success: function (json) {
      $(".subscribe-form input").addClass(json.class);
      $(".subscribe-form")
      ...
      setTimeout(function () {
        $(".subscribe-form input").removeClass(json.class);
        $(".subscribe-form")
          .find(".control-message")
          .removeClass(json.class)
          .html(``);
      }, 3000);
    },
...
function kpRequest() {
  $.ajax({
    url: "index.php?route=tool/request",
    type: "post",
    data:
      "name=" +
      $('#kp-request-form input[name="name"]').val() +
      "&phone=" +
    ...
    success: function (json) {
      $(".control-message")
        ...
        .html(`<span>${json.message}</span>`);
      setTimeout(function () {
        $(".control-message").removeClass(json.class).html(``);
      }, 3000);
      $("#kp-request-form").reset();
    },
    error: function (xhr, ajaxOptions, thrownError) {
      alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
    },
